...
@section('content')
    ...
    <div class="content-wrapper p-3">
        <div class="btn-group mb-2" role="group" aria-label="Basic example">
            <a href="{{ route('createHome') }}" class="btn btn-sm btn-success text-light"> Create Home</a>
            <button class="btn btn-sm btn-primary text-light hide" data-toggle="modal" data-original-title="test"
        ...
        <div class="card border border-danger">
            ...
            <div class="card-header p-1 hide">
                <ul class="nav nav-pills" id="tabMenu">
                    <li class="nav-item">
                        <a class="nav-link active btn-sm py-1 m-1" data-toggle="pill" href="#image">Image
                            [{{ $Home->count() }}]</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn-sm py-1 m-1" data-toggle="pill" href="#video">Video
                            [{{ $Home->count() }}]</a>
                    </li>
                </ul>
            </div>
                            ...
                            <tbody class="text-center">
                                @foreach ($Home as $item)
                                    <tr>
                                        ...
                                        <td class="p-2"><img src="{{ $item->image }}" width="120" height="100">
                                        </td>
                                        <td>{!! $item->title !!}</td>
                                        ...
                                        <td width="8%">
                                            @if ($item->status == 1)
                                                <a href="{{ url('itemStatus', [$item->id, 'homes', 'tabName']) }}"
                                                    class="btn px-1 btn-sm btn-success"
                                                    title="Click for inactive">Active</a>
                                            @else
                                                <a href="{{ url('itemStatus', [$item->id, 'homes', 'tabName']) }}"
                                                    class="btn px-1 btn-sm btn-danger" title="Click for active">Inactive</a>
                                            @endif
                                        </td>
                                        <td width="8%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-sm btn-success text-light" href="{{ route('editHome',$item->id) }}">Edit</a>

                                                <a class="btn btn-sm btn-danger text-light"
                                                    href="{{ url('itemDelete', [$item->id, 'homes', 'tabName']) }}"
                            ...
                            <tbody class="text-center">
                                @foreach ($Home as $item)
                                    <tr>
                                        ...
                                        <td width="8%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-sm btn-success text-light editHome" data-toggle="modal"
                                                    data-target="#editHome" data-id="{{ $item->id }}">Edit</a>
...
@section('js')
    {{-- Add image --}}
    <div class="modal fade" id="addImage" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                    ...
                    <form action="{{ url('addHome') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control imageFile" id="image" name="image"
                                    required>
                            </div>
                            <div class="form-group">
    ...
    {{-- edit home image --}}
    <div class="modal fade" id="editHome" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    {{-- Add video --}}
    <div class="modal fade" id="addVideo" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
